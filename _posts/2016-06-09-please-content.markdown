...
# 목차
  1. [문제 상황, 문제에 따른 목적 및 요구사항 도출](문제 상황, 문제에 따른 목적 및 요구사항 도출)
  2. [핵심 아이디어 및 전체 시스템 구조](핵심 아이디어 및 전체 시스템 구조)
  3. [기존 제품과의 차별성 및 장점](기존 제품과의 차별성 및 장점)
  4. [시스템 설계](시스템 설계)  
      1) [시스템의 목적](#시스템의 목적)  
      2) [시스템 구조](#시스템 구조)  
      3) [시스템의 기능](#시스템의 기능)  
      4) [시스템의 구성 요소 및 각 구성 요소의 기능, 입출력 데이터](#시스템의 구성 요소 및 각 구성 요소의 기능, 입출력 데이터)  
  5. [팀원 및 역할분담](팀원 및 역할분담)
